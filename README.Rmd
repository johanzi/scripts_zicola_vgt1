...
index="/home/zicola/fasta/B73_NAM5/B73_NAM5_chr_only/zmays"
...
| sample              | GEM peaks |
|---------------------|-----------|
| SRR29006028_ZmRap27 | 12,569    |
| SRR29006029_ZmRap27 | 11,296    |
| SRR8524985_EREB71   | 14,058    |
| SRR8524986_EREB71   | 16,025    |
| SRR8524995_EREB172  | 66,184    |
| SRR8524996_EREB172  | 86,132    |
| SRR8525011_EREB18   | 9,180     |
| SRR8525012_EREB18   | 25,600    |
| SRR8525043_EREB34   | 19,066    |
| SRR8525044_EREB34   | 7,023     |
| SRR8525047_EREB198  | 56,230    |
| SRR8525048_EREB109  | 60,063    |
| SRR8525068_EREB209  | 75,235    |
| SRR8525069_EREB209  | 96,090    |
| SRR8525077_EREB211  | 43,501    |
| SRR8525078_EREB211  | 48,076    |
| SRR8525082_EREB17   | 22,730    |
| SRR8525083_EREB17   | 23,818    |
| SRR8525086_EREB198  | 22,767    |
| SRR8525104_EREB54   | 74,060    |
| SRR8525105_EREB54   | 47,985    |
| SRR8525118_EREB97   | 60,541    |
| SRR8525120_EREB97   | 36,508    |
| SRR8525134_EREB147  | 68,270    |
| SRR8525136_EREB147  | 55,085    |
| SRR8525151_EREB109  | 47,773    |
...
temp = list.files(path="/data/meme_chip", pattern="*.txt")
...
### Install NGS plot and maize database

Using existing ngsplot database for B73 AGPv3 genome assembly.
...
# Download the genome annotation file for maize v3 
# ngsplotdb_AGPv3_26_3.00.tar.gz and # (https://drive.google.com/drive/folders/0B1PVLadG_dCKNEsybkh5TE9XZ1E?resourcekey=0-ux6XMoJr0qaS6lemqPJBpQ).
...
bowtie2 -p 10 \
  ...
  samtools sort -@ 4 | \
  samtools rmdup - mapped_AGPv3/${i}.bam
...
# Contrast contrast conf file
echo -e 'mapped_AGPv3/SRR29006029_ZmRap27.bam:mapped_AGPv3/SRR12022262_control.bam\t-1\t"SRR29006029_ZmRap27"' \
  >> ngsplot/conf_file_contrast
echo -e 'mapped_AGPv3/SRR29006028_ZmRap27.bam:mapped_AGPv3/SRR12022262_control.bam\t-1\t"SRR29006028_ZmRap2"' \
>> ngsplot/conf_file_contrast

# Read density at TSS (-/+ 1 kb) with normalization by the control sample
ngs.plot.r -P 0 -G AGPv3 -R tss -C ngsplot/conf_file \
-O ngsplot/ChIP_TSS_1kb -T ngsplot/ChIP_TSS_1kb_normalized -L 1000

```

Output file is `ChIP_TSS_1kb_normalized.avgprof.pdf`
